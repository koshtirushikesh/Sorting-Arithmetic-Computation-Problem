# read value from dicnory to array
declare -A answer 
...
operation=0;
arrayAnswer[((operation++))]=${answer[operation1]};
arrayAnswer[((operation++))]=${answer[operation2]};
arrayAnswer[((operation++))]=${answer[operation3]};
arrayAnswer[((operation++))]=${answer[operation4]};
